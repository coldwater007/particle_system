...
int GLCanvas::width = 1400;
int GLCanvas::height = 1400;
...
//初始化函数
void GLCanvas::initialize(Parser *_parser, float _refresh, float _dt, int _integrator_color, int _draw_vectors, float _acceleration_scale, int _motion_blur)
{
